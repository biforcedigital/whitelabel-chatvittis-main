      ...
      <Paper className={classes.mainPaper} onScroll={handleScroll}>
        <div className={classes.contentContainer}>
          <Grid container spacing={2}>
            <Grid item xs={4}>
              <Typography variant="subtitle2" style={{ fontWeight: 'bold', color: '#171717' }}>
                Nome
              </Typography>
            </Grid>
            <Grid item xs={4}>
              <Typography variant="subtitle2" style={{ fontWeight: 'bold', color: '#171717', textAlign: 'center' }}>
                Status
              </Typography>
            </Grid>
            <Grid item xs={4}>
              <Typography variant="subtitle2" style={{ fontWeight: 'bold', color: '#171717', textAlign: 'right' }}>
          ...
          {loading ? (
            <div className={classes.loading}>
              <CircularProgress style={{ color: "#08c2c2" }} />
            </div>
          ) : (
