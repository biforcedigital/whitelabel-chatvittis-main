...
const App = () => {
      ...
      createTheme(
        {
          ...
          palette: {
            ...
            dark: { main: mode === "light" ? "#171717" : "#F3F3F3" },
            light: { main: mode === "light" ? "#F3F3F3" : "#171717" },
            fontColor: mode === "light" ? primaryColorLight : primaryColorDark,
            tabHeaderBackground: mode === "light" ? "#EEE" : "#666",
            optionsBackground: mode === "light" ? "#fafafa" : "#171717",
            fancyBackground: mode === "light" ? "#fafafa" : "#171717",
            total: mode === "light" ? "#fff" : "#222",
            messageIcons: mode === "light" ? "grey" : "#F3F3F3",
            inputBackground: mode === "light" ? "#FFFFFF" : "#171717",
  ...
  useEffect(() => {
    ...
    getPublicSetting("primaryColorLight")
      .then((color) => {
        setPrimaryColorLight(color || "#171717");
      })
      .catch((error) => {
    ...
    getPublicSetting("appName")
      .then((name) => {
        setAppName(name || "chatvittis");
      })
      .catch((error) => {
        console.log("!==== Erro ao carregar temas: ====!", error);
        setAppName("chatvittis");
      });
