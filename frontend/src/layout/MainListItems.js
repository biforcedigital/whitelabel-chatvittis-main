          ...
          <>
            <Tooltip title={collapsed ? i18n.t("mainDrawer.listItems.management") : ""} placement="right">
              ...
              >
                ...
                />
                {openDashboardSubmenu ? <ExpandLessIcon style={{ color: "#08c2c2" }} /> : <ExpandMoreIcon style={{ color: "#08c2c2" }} />}
              </ListItem>
            </Tooltip>
            <Collapse
                  ...
                  <>
                    <Tooltip title={collapsed ? i18n.t("mainDrawer.listItems.campaigns") : ""} placement="right">
                      ...
                      >
                        ...
                        />
                        {openCampaignSubmenu ? <ExpandLessIcon style={{ color: "#08c2c2" }} /> : <ExpandMoreIcon style={{ color: "#08c2c2" }} />}
                      </ListItem>
                    </Tooltip>
                    <Collapse
                ...
                <>
                  <Tooltip title={collapsed ? i18n.t("mainDrawer.listItems.campaigns") : ""} placement="right">
                    ...
                    >
                      ...
                      />
                      {openFlowSubmenu ? <ExpandLessIcon style={{ color: "#08c2c2" }} /> : <ExpandMoreIcon style={{ color: "#08c2c2" }} />}
                    </ListItem>
                  </Tooltip>
